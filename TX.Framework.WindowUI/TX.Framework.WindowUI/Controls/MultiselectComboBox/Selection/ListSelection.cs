...
namespace System.Windows.Forms {
    public class ListSelection<T> : List<ObjectSelection<T>> {
        ...
        public ListSelection(IEnumerable source, bool showCounts, string usePropertyAsDisplayName) : this(source, showCounts) {
            DisplayNameProperty = usePropertyAsDisplayName;
        }

        public ListSelection(IEnumerable source, bool showCounts) : base() {
            _Source = source;
