...
namespace System.Windows.Forms {
    ...
    public partial class Popup : ToolStripDropDown {
        ...
        private const int TOTAL_DURATION = 0; // ML : 2007-11-05 : was 100 but caused a flicker.
        private const int FRAME_DURATION = TOTAL_DURATION / FRAMES;
        ...
        protected override void SetVisibleCore(bool visible) {
            ...
            for (int i = 1; i <= FRAMES; i++) {
                if (i > 1) {
                    System.Threading.Thread.Sleep(FRAME_DURATION);
                }
