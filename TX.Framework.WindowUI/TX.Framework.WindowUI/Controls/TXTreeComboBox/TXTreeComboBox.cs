...
namespace TX.Framework.WindowUI.Controls {
    ...
    public partial class TreeComboBox : UserControl {
        ...
        private void InitControls() {
            ...
            this.m_DropdownButton.Click += new EventHandler(DropdownButton_Click);
            ...
            this.m_TreeView.DoubleClick += new EventHandler(TreeView_DoubleClick);
            this.m_TreeView.KeyDown += new KeyEventHandler(TreeView_KeyDown);
            this.m_TreeView.LostFocus += new EventHandler(TreeView_LostFocus);
            this.m_TreeView.BeforeExpand += new TreeViewCancelEventHandler(TreeView_BeforeExpand);
            this.m_TreeView.BeforeCollapse += new TreeViewCancelEventHandler(TreeComboBox_BeforeCollapse);
            this.m_TreeView.AfterExpand += new TreeViewEventHandler(TreeView_AfterExpand);
        ...
        private void TreeView_KeyDown(object sender, KeyEventArgs e) {
            //如果按下回车表示要选中当前节点
            if (e.KeyCode == Keys.Enter) {
                this.TreeView_DoubleClick(sender, EventArgs.Empty);
            }
        }
