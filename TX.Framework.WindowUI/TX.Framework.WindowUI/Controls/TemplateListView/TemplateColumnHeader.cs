...
namespace TX.Framework.WindowUI.Controls {
    public class TemplateColumnHeader : ColumnHeader, IComparer {
        ...
        public TemplateColumnHeader() : base() {
            //this.TextAlign = HorizontalAlignment.Center;
            _CanEdit = false;
        }

        [Description("是否允许修改"), DefaultValue(false)]
        public bool CanEdit { get; set; }

        [Description("ColumnTemplate"), Localizable(true)]
        public string Template { get; set; }

        [Description("数据类型"), Localizable(true), DefaultValue(HeaderDataType.String)]
