...
namespace System.Reflection.Emit {
    internal class ArrayGetEmitter : BaseEmitter {
        public ArrayGetEmitter(Type targetType) : base(new CallInfo(targetType, Flags.InstanceAnyVisibility, MemberTypes.Method, Constants.ArrayGetterName, new[] { typeof(int) }, null)) { }
