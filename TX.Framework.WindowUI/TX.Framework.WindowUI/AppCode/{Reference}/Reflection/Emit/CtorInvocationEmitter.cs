...
namespace System.Reflection.Emit {
    internal class CtorInvocationEmitter : InvocationEmitter {
        public CtorInvocationEmitter(ConstructorInfo ctorInfo, Flags bindingFlags) : this(ctorInfo.DeclaringType, bindingFlags, ctorInfo.GetParameters().ToTypeArray(), ctorInfo) { }

        public CtorInvocationEmitter(Type targetType, Flags bindingFlags, Type[] paramTypes) : this(targetType, bindingFlags, paramTypes, null) { }

        private CtorInvocationEmitter(Type targetType, Flags flags, Type[] parameterTypes, ConstructorInfo ctorInfo) : base(new CallInfo(targetType, flags, MemberTypes.Constructor, targetType.Name, parameterTypes, ctorInfo)) { }
