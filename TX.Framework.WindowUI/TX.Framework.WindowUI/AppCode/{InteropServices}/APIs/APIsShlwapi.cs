...
namespace System.Runtime.InteropServices.APIs {
    public class APIsShlwapi {
        ...
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern bool PathMakePretty(System.Text.StringBuilder path);
        #endregion
        ...
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern bool PathMatchSpec(string fileparam, string spec);
        #endregion
        ...
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern int PathParseIconLocation(System.Text.StringBuilder IconFile);
        #endregion
        ...
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern void PathQuoteSpaces(System.Text.StringBuilder lpsz);
        #endregion
        ...
        /// </summary>
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern void PathRemoveArgs(System.Text.StringBuilder path);
        #endregion
        ...
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern string PathRemoveBackslash(string path);
        #endregion
        #region DllGetVersion
        [DllImport("shlwapi.dll", CharSet = CharSet.Auto)]
        public static extern int DllGetVersion(ref APIsStructs.DLLVERSIONINFO2 path);
        #endregion
    }
}
