...
namespace TX.Framework.WindowUI {
    ...
    internal class SkinThemeDefault : SkinTheme {
        ...
        public override void IniSkinTheme() {
            ...
            this.HeightLightControlColor = new GradientColor(Color.FromArgb(140, 67, 165, 220), Color.FromArgb(67, 165, 220), null, null);
            this.FocusedControlColor = new GradientColor(Color.FromArgb(67, 165, 220), Color.FromArgb(39, 88, 142), null, null);
