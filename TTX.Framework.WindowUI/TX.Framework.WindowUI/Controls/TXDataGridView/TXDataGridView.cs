                ...
                if (e.RowIndex > -1 && e.ColumnIndex > -1) {
                    ...
                    if (e.RowIndex == -1) {
                        if (SpanRows.ContainsKey(e.ColumnIndex)) { //被合并的列
                            ...
                            //画上半部分底色
                            g.FillRectangle(
                                new SolidBrush(this._mergecolumnheaderbackcolor),
                                left,
                                top,
                                right - left,
                                (bottom - top) / 2);
                            ...
                            g.DrawString(
                                ...
                                new Rectangle(left, (top + bottom) / 2, right - left, (bottom - top) / 2),
                                sf);
                            ...
                            g.DrawString(
                                SpanRows[e.ColumnIndex].Text,
                                e.CellStyle.Font,
                                Brushes.Black,
                                new Rectangle(left, top, right - left, (bottom - top) / 2),
                                sf);
